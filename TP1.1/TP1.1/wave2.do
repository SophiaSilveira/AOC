...
add wave -noupdate -divider cache_coisas
add wave -radix hexa /cpu_tb/Cache_Mem/miss_c
add wave -radix hexa /cpu_tb/Cache_Mem/tag
add wave -radix hexa /cpu_tb/Cache_Mem/linha
add wave -radix hexa /cpu_tb/Cache_Mem/bloco
add wave -radix hexa /cpu_tb/Cache_Mem/hit
add wave -radix hexa /cpu_tb/Cache_Mem/miss
add wave -radix hexa /cpu_tb/Cache_Mem/status
add wave -radix hexa /cpu_tb/Cache_Mem/count
add wave -radix hexa /cpu_tb/Cache_Mem/cs
add wave -radix hexa /cpu_tb/Cache_Mem/ns
add wave -radix hexa /cpu_tb/Cache_Mem/addressOut
